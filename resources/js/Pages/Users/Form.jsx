        ...
        <DashboardLayout>
            ...
            <div className="max-w-xl space-y-6">
                <div className="flex items-center gap-3">
                    <Link href={route('users.index')} className="p-2 rounded-lg hover:bg-gray-700 text-gray-400 transition">
                        <ArrowLeft size={18} />
                    </Link>
                ...
                <form onSubmit={submit} className="space-y-5">
                    ...
                    <div className="flex gap-3">
                        ...
                        <Link href={route('users.index')} className="px-5 py-2 bg-gray-700 hover:bg-gray-600 text-white rounded-lg text-sm transition">
                            Cancelar
                        </Link>
                    </div>
                </form>
