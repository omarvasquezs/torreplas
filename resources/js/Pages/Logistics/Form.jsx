            ...
            <div className="max-w-2xl space-y-6">
                ...
                <form onSubmit={submit} className="space-y-5">
                    <section className="bg-gray-800/50 rounded-xl border border-gray-700/50 p-5 space-y-4">
                        ...
                        <div>
                            <label className="block text-sm text-gray-400 mb-1">Pedido asociado (opcional)</label>
                        ...
                        <div>
                            <label className="block text-sm text-gray-400 mb-1">Transportista (opcional)</label>
                    ...
                    <div className="flex gap-3">
                        ...
                        <Link href={route('deliveries.index')} className="px-5 py-2 bg-gray-700 hover:bg-gray-600 text-white rounded-lg text-sm transition">
                            Cancelar
                        </Link>
                    </div>
                </form>
