            ...
            <div className="space-y-6">
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-gray-600 text-sm mt-1">Control de despachos y entregas</p>
                    </div>
                    <div className="flex gap-2">
                        <Link href={route('carriers.index')} className="px-3 py-2 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-lg text-sm transition">
                            Transportistas
                        </Link>
                    ...
                    <table className="w-full text-sm">
                        ...
                        <tbody className="divide-y divide-gray-700/50">
                            ...
                            {deliveries.data.map(d => {
                                ...
                                return (
                                    <tr key={d.id} className="hover:bg-gray-100/30 transition">
                                        ...
                                        <td className="px-4 py-3">
                                            {d.order ? (
                                                <div>
                                                    ...
                                                    <p className="text-gray-600 text-xs">{d.order.client?.name}</p>
                                                </div>
                                            ) : <span className="text-gray-500">—</span>}
                                        </td>
                                        <td className="px-4 py-3 text-gray-700 max-w-48 truncate">{d.destination_address}</td>
                                        <td className="px-4 py-3 text-gray-600">{d.carrier?.name || '—'}</td>
                                        <td className="px-4 py-3 text-gray-600">{d.scheduled_date}</td>
                                        <td className="px-4 py-3">
