    ...
    return (
        <DashboardLayout>
            ...
            <div className="space-y-6">
                ...
                {show && (
                    <form onSubmit={submit} className="bg-gray-800/50 rounded-xl border border-gray-700/50 p-5 space-y-4">
                        ...
                        <div className="flex gap-3">
                            ...
                            <button type="button" onClick={() => setShow(false)} className="px-4 py-2 bg-gray-700 hover:bg-gray-600 text-white rounded-lg text-sm">
                                Cancelar
                            </button>
                        </div>
                    </form>
                        ...
                        <tbody className="divide-y divide-gray-700/50">
                            ...
                            {carriers.data.map(c => (
                                <tr key={c.id} className="hover:bg-gray-700/30">
                                    ...
                                    <td className="px-4 py-3 text-gray-400 font-mono text-xs">{c.document_number || '—'}</td>
                                    <td className="px-4 py-3 text-gray-300 font-mono">{c.license_plate || '—'}</td>
