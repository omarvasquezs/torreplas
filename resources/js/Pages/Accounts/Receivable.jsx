            ...
            <div className="bg-white border border-gray-200 rounded-xl w-full max-w-md">
                ...
                <form onSubmit={submit} className="p-4 space-y-4">
                    <div className="bg-gray-100 rounded-lg p-3 text-sm text-gray-700 space-y-1">
                        <div><span className="text-gray-600">Cliente:</span> {order?.client?.name}</div>
                        <div><span className="text-gray-600">Total:</span> S/ {fmt(order?.total)}</div>
                        <div><span className="text-gray-600">Pendiente:</span>
        ...
        <DashboardLayout>
            ...
            <div className="space-y-6">
                <div>
                    ...
                    <p className="text-gray-600 text-sm">Pedidos pendientes de pago</p>
                </div>
                                ...
                                {orders?.length ? orders.map(o => {
                                    ...
                                    return (
                                        <tr key={o.id} className="border-b border-gray-200 hover:bg-gray-50">
                                            ...
                                            <td className="p-3 text-gray-600 text-xs">{o.created_at?.split('T')[0]}</td>
