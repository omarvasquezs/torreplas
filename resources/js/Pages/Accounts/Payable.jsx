            ...
            <div className="bg-white border border-gray-200 rounded-xl w-full max-w-md">
                ...
                <form onSubmit={submit} className="p-4 space-y-4">
                    <div className="bg-gray-100 rounded-lg p-3 text-sm text-gray-700 space-y-1">
                        <div><span className="text-gray-600">Proveedor:</span> {purchase?.supplier?.name}</div>
                        <div><span className="text-gray-600">Total OC:</span> S/ {fmt(purchase?.total)}</div>
                    ...
                    <div>
                        <label className="block text-gray-600 text-xs mb-1">Monto a pagar <span className="text-red-400">*</span></label>
                    ...
                    <div>
                        <label className="block text-gray-600 text-xs mb-1">Método de pago</label>
                    ...
                    <div>
                        <label className="block text-gray-600 text-xs mb-1">Referencia / N° operación</label>
        ...
        <DashboardLayout>
            ...
            <div className="space-y-6">
                <div>
                    ...
                    <p className="text-gray-600 text-sm">Órdenes de compra pendientes de pago a proveedores</p>
                </div>
                                ...
                                {purchases?.length ? purchases.map(p => {
                                    ...
                                    return (
                                        <tr key={p.id} className="border-b border-gray-200 hover:bg-gray-50">
                                            ...
                                            <td className="p-3 text-gray-700">{p.supplier?.name ?? '—'}</td>
                                            <td className="p-3 text-gray-600 text-xs">{p.created_at?.split('T')[0]}</td>
